...
//create random element
 ...
 // choose a random tweet
  ...
  client.post('statuses/update', {status: "RT @" + selected_tweet.screen_name + " " + selected_tweet.text + " " + phrase + " #AdamSandler and #Trump = Poetry"}, function(error, tweet, response) {
    if (!error) {
      console.log(tweet);
    }
    }); 
...
tweetSandler();
setInterval(tweetSandler, 14400000)
